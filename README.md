...
- `geometry_branch/eval_snn_vo_ate.py`: VO trajectory and ATE evaluation under the default local-window protocol.
...
- VO / ATE evaluation under the local-window protocol;
