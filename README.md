...
- `geometry_branch/eval_snn_vo_ate.py`: VO trajectory and ATE evaluation with both `windowed` and `full_trajectory` protocols.
...
- VO / ATE evaluation under either local-window or full-trajectory protocols;
